...
function initCharts() {
    ...
    // 2. Gráfico Evolución del Consumo (Línea)
    const ctx2 = document.getElementById('chartEvolucionConsumo').getContext('2d');
    new Chart(ctx2, {
        type: 'line',
        data: {
...
async function loadDashboardData() {
    try {
        ...
        document.getElementById('stat-total-productos').textContent = totalProds || 0;
        ...
        document.getElementById('stat-stock-bajo').textContent = countBajo || stockBajoData?.length || 0;
        ...
        if (stockBajoData && stockBajoData.length > 0) {
            ...
            // Ejemplo de demostración cuando está vacío
            tbody.innerHTML = `
        ...
        if (movimientos && movimientos.length > 0) {
            ...
            // Ejemplo por defecto para simular la interfaz del diseño
